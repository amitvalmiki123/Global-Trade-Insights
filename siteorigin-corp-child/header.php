...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Figtree:wght@600;700&family=Red+Hat+Display:wght@500;600;700&family=Red+Hat+Text:wght@400;600;700&display=swap" rel="stylesheet">
	...
	if ( siteorigin_page_setting( 'header', true ) ) {
		...
		<header id="masthead" class="site-header<?php echo $header_classes; ?>" <?php if ( siteorigin_setting( 'header_scales' ) ) echo 'data-scale-logo="true"'; ?> >
			...
			<div class="corp-container">
				...
				<div class="site-header-inner" data-aos="fade-in" data-aos-duration="1000">
